...
if ~isempty(filenameA) ||~isempty(filenameB)
    ...
    if get(guiHandlesStats.crossAxesStats, 'Value') == 1
        ...
        if ~isempty(filenameA)
            ...
            set(ax(2).YLabel, 'String', 'deg/s');

            if get(guiHandlesStats.degsecStick, 'Value') == 1,
                set(ax(2).YLabel, 'String', 'deg/s/stick travel units');
            end
            ...
            set(hhist, 'tickdir', 'in', 'xlim', [1 100], 'xtick', [1 20 40 60 80 100], 'ylim', [0 .1], 'ytick', [0 .05 .1], 'xticklabel', {0 20 40 60 80 100}, 'yticklabel', {0 5 10}, 'fontsize', fontsz5, 'Position', [posInfo.statsPos(1, :)]);
            axis([1 100 0 .1])
            ...
            set(hhist, 'tickdir', 'in', 'xlim', [1 100], 'xtick', [1 20 40 60 80 100], 'ylim', [0 .1], 'ytick', [0 .05 .1], 'xticklabel', {0 20 40 60 80 100}, 'yticklabel', {0 5 10}, 'fontsize', fontsz5, 'Position', [posInfo.statsPos(2, :)]);
            axis([1 100 0 .1])
            ...
            set(hhist, 'tickdir', 'in', 'xlim', [1 100], 'xtick', [1 20 40 60 80 100], 'ylim', [0 .1], 'ytick', [0 .05 .1], 'xticklabel', {0 20 40 60 80 100}, 'yticklabel', {0 5 10}, 'fontsize', fontsz5, 'Position', [posInfo.statsPos(3, :)]);
            axis([1 100 0 .1])
            ...
            set(hhist, 'ycolor', [colorA], 'tickdir', 'in', 'xlim', [1 100], 'xtick', [1 20 40 60 80 100], 'ylim', [0 .1], 'ytick', [0 .05 .1], 'xticklabel', {0 20 40 60 80 100}, 'yticklabel', {0 5 10}, 'fontsize', fontsz5, 'Position', [posInfo.statsPos(4, :)]);
            axis([1 100 0 .1])
        end
        ...
        if ~isempty(filenameB)
            ...
            set(hhist, 'tickdir', 'in', 'xlim', [1 100], 'xtick', [1 20 40 60 80 100], 'ylim', [0 .1], 'ytick', [0 .05 .1], 'xticklabel', {0 20 40 60 80 100}, 'yticklabel', {0 5 10}, 'fontsize', fontsz5, 'Position', [posInfo.statsPos(5, :)]);
            axis([1 100 0 .1])
            ...
            set(hhist, 'tickdir', 'in', 'xlim', [1 100], 'xtick', [1 20 40 60 80 100], 'ylim', [0 .1], 'ytick', [0 .05 .1], 'xticklabel', {0 20 40 60 80 100}, 'yticklabel', {0 5 10}, 'fontsize', fontsz5, 'Position', [posInfo.statsPos(6, :)]);
            axis([1 100 0 .1])
            ...
            set(hhist, 'tickdir', 'in', 'xlim', [1 100], 'xtick', [1 20 40 60 80 100], 'ylim', [0 .1], 'ytick', [0 .05 .1], 'xticklabel', {0 20 40 60 80 100}, 'yticklabel', {0 5 10}, 'fontsize', fontsz5, 'Position', [posInfo.statsPos(7, :)]);
            axis([1 100 0 .1])
            ...
            set(hhist, 'ycolor', [colorB], 'tickdir', 'in', 'xlim', [1 100], 'xtick', [1 20 40 60 80 100], 'ylim', [0 .1], 'ytick', [0 .05 .1], 'xticklabel', {0 20 40 60 80 100}, 'yticklabel', {0 5 10}, 'fontsize', fontsz5, 'Position', [posInfo.statsPos(8, :)]);
            axis([1 100 0 .1])
        end
